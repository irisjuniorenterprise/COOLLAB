...
class UserControllerTest extends WebTestCase
{
    ...
    public function testNew(): void
    {
        ...
        $this->client->submitForm('Save', [
            ...
            'user[isBanned]' => 'Testing',
            'user[cv]' => 'Testing',
            'user[cin]' => 'Testing',
            'user[workPlace]' => 'Testing',
            'user[club]' => 'Testing',
            'user[score]' => 'Testing',
        ]);
    ...
    public function testShow(): void
    {
        ...
        $fixture->setIsBanned('My Title');
        $fixture->setCv('My Title');
        $fixture->setCin('My Title');
        $fixture->setWorkPlace('My Title');
    ...
    public function testEdit(): void
    {
        ...
        $this->client->submitForm('Update', [
            ...
            'user[isBanned]' => 'Something New',
            'user[cv]' => 'Something New',
            'user[cin]' => 'Something New',
            'user[workPlace]' => 'Something New',
            'user[club]' => 'Something New',
        ...
        self::assertSame('Something New', $fixture[0]->getIsBanned());
        self::assertSame('Something New', $fixture[0]->getCv());
        self::assertSame('Something New', $fixture[0]->getCin());
        self::assertSame('Something New', $fixture[0]->getWorkPlace());
