 ...
 */
final class Version20221118143106 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE competition DROP file');
        $this->addSql('ALTER TABLE training_session DROP file, CHANGE category_id category_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE competition ADD file LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
        $this->addSql('ALTER TABLE training_session ADD file LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', CHANGE category_id category_id INT DEFAULT NULL');
    }
}
