 ...
 */
final class Version20221117124042 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, address VARCHAR(255) NOT NULL, is_banned TINYINT(1) NOT NULL, cv LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', cin VARCHAR(255) DEFAULT NULL, work_place LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', club LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', score DOUBLE PRECISION DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
